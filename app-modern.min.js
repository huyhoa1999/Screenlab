...
/*                 if( angular.isDefined( data.area ) ){
    ...
    if(typeof add_js_mini_cart != 'undefined') {
        $scope.showMiniCart = function() {
            jQuery('.custom_h').toggleClass('active');
        }
        jQuery('.header_h i').on('click',function(){
            jQuery('.custom_h').toggleClass('active');
        });
    }
                            ...
                            if(data.flag == 'success'){
                                ...
                                if( type == 'saveforlater' ){
                                    ...
                                    if(NBDESIGNCONFIG.show_nbo_option == "1" && ( NBDESIGNCONFIG.task == 'new' || NBDESIGNCONFIG.task2 == 'update' ) ){
                                        ...
                                        nbd_window.jQuery('.variations_form, form.cart').append('<input name="ct_add" type="hidden" value="'+NBDESIGNCONFIG.product_id+'" />');
                                        jQuery('.variations_form, form.cart').submit();
                                        return;
                                    }
                                    ...
                                    if(typeof add_js_mini_cart != 'undefined') {
                                        window.location = NBDESIGNCONFIG.nbd_create_own_page + '?product_id=' + NBDESIGNCONFIG.product_id;
                                        return;
                                    }
